...
function validate() {
  ...
  if( document.myForm.year.value == "" || document.myForm.year.value.length !=4 || document.myForm.year.value >2050 || document.myForm.year.value <=1900) {
...
function calculateDayValue() {
  ...
  CC = parseInt(year.slice(0,1));
  YY = parseInt(year.slice(2,3));
